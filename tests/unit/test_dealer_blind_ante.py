...
# not currently implemented in the game logic

# def test_ante_only_mode():
#     """Test when only ante is configured (blind = 0)."""
#     rules = {
#         "game": "Ante Only Test",
#         "players": {"min": 2, "max": 9},
#         "deck": {"type": "standard", "cards": 52},
...
#         "gamePlay": [
#             {"bet": {"type": "blinds"}, "name": "Post Ante"},
...
#     # Only dealer should post ante
#     dealer_bet = game.betting.current_bets.get("p1")
#     assert dealer_bet is not None
#     assert dealer_bet.amount == 5  # Just ante
#     assert game.betting.get_ante_total() == 5
#     assert game.betting.current_bet == 0  # No blind means no current bet
