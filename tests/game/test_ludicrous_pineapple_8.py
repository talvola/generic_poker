"""Minimal end-to-end test for ludicrous_pineapple_8."""
import pytest
...
def setup_test_game():
    """Setup a 3-player ludicrous_pineapple_8 game with a mock deck."""
    rules = load_rules_from_file('ludicrous_pineapple_8')
    game = Game(
        rules=rules,
...
def test_ludicrous_pineapple_8_minimal_flow():
    """Test minimal flow for ludicrous_pineapple_8 from start to showdown."""
    ...
    assert winning_hand[0].hand_description == 'Full House, Tens over Twos'  # Updated from run
