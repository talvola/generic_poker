"""Minimal end-to-end test for badugi."""
import pytest
...
def setup_test_game():
    """Setup a 3-player badugi game with a mock deck."""
    rules = load_rules_from_file('badugi')
    game = Game(
        rules=rules,
...
def test_badugi_minimal_flow():
    """Test minimal flow for badugi from start to showdown."""
