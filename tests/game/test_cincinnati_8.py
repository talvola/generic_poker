"""Minimal end-to-end test for cincinnati_8."""
import pytest
...
def setup_test_game():
    """Setup a 3-player cincinnati_8 game with a mock deck."""
    rules = load_rules_from_file('cincinnati_8')
    game = Game(
        rules=rules,
...
def test_cincinnati_8_minimal_flow():
    """Test minimal flow for cincinnati_8 from start to showdown."""
