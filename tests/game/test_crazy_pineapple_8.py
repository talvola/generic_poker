"""Minimal end-to-end test for crazy_pineapple_8."""
import pytest
...
def setup_test_game():
    """Setup a 3-player crazy_pineapple_8 game with a mock deck."""
    rules = load_rules_from_file('crazy_pineapple_8')
    game = Game(
        rules=rules,
...
def test_crazy_pineapple_8_minimal_flow():
    """Test minimal flow for crazy_pineapple_8 from start to showdown."""
