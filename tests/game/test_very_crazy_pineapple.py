"""Minimal end-to-end test for very_crazy_pineapple."""
import pytest
...
def setup_test_game():
    """Setup a 3-player very_crazy_pineapple game with a mock deck."""
    rules = load_rules_from_file('very_crazy_pineapple')
    game = Game(
        rules=rules,
...
def test_very_crazy_pineapple_minimal_flow():
    """Test minimal flow for very_crazy_pineapple from start to showdown."""
