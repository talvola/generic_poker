"""Minimal end-to-end test for crazy_pineapple."""
import pytest
...
def setup_test_game():
    """Setup a 3-player crazy_pineapple game with a mock deck."""
    rules = load_rules_from_file('crazy_pineapple')
    game = Game(
        rules=rules,
...
def test_crazy_pineapple_minimal_flow():
    """Test minimal flow for crazy_pineapple from start to showdown."""
