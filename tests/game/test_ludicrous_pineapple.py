"""Minimal end-to-end test for ludicrous_pineapple."""
import pytest
...
def setup_test_game():
    """Setup a 3-player ludicrous_pineapple game with a mock deck."""
    rules = load_rules_from_file('ludicrous_pineapple')
    game = Game(
        rules=rules,
...
def test_ludicrous_pineapple_minimal_flow():
    """Test minimal flow for ludicrous_pineapple from start to showdown."""
