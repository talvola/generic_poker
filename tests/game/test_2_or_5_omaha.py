"""Minimal end-to-end test for 2_or_5_omaha."""
import pytest
...
def setup_test_game():
    """Setup a 3-player 2_or_5_omaha game with a mock deck."""
    rules = load_rules_from_file('2_or_5_omaha')
    game = Game(
        rules=rules,
...
def test_2_or_5_omaha_minimal_flow():
    """Test minimal flow for 2_or_5_omaha from start to showdown."""
    ...
    assert winning_hand[0].hand_description == 'Full House, Twos over Kings'  # Updated from run
