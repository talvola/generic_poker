...
def generate_wild_card_hands(hands, unique_hands):
    for hand, rank, ordered_rank in hands:
        ...
        # Generate hands with 1 to 2 wild cards
        for num_wild_cards in range(1, 2):
            for positions in itertools.combinations(range(2), num_wild_cards):
        ...
        for num_bug_cards in range(1, 2):
...
# Example usage
input_filename = 'all_card_hands_ranked_two_card_27_ja_ffh_high.csv'  # Input file name
output_filename = 'all_card_hands_ranked_two_card_27_ja_ffh_high_wild_bug.csv'  # Output file name
