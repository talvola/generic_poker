...
class EvaluationConfigLoader:
    ...
    def get_config(self, eval_type: str) -> Optional[EvaluationConfig]:
        """
    ...
    def get_ranking_file_path(self, eval_type: str) -> Optional[str]:
    ...
    def get_description_file_path(self, eval_type: str) -> Optional[str]:
    ...
    def get_description_generator_config(self, eval_type: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            'generator': config.description_data.generator,
            'parameters': config.description_data.parameters or {}
        }

# Global instance
evaluation_config_loader = EvaluationConfigLoader()

def get_evaluation_config(eval_type: str) -> Optional[EvaluationConfig]:
