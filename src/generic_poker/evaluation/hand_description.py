...
from generic_poker.evaluation.constants import BASE_RANKS, RANK_ORDERS, SUIT_ORDER
...
class HandDescriber:
    ...
    HAND_DESCRIPTION_FILES: dict[EvaluationType, str] = {
        ...
        EvaluationType.ONE_CARD_LOW_SPADE: "all_card_hands_description_one_card_low_spade.csv",
        EvaluationType.ONE_CARD_LOW_HEART: "all_card_hands_description_one_card_low_heart.csv",
        EvaluationType.ONE_CARD_LOW_DIAMOND: "all_card_hands_description_one_card_low_diamond.csv",
        EvaluationType.ONE_CARD_LOW_CLUB: "all_card_hands_description_one_card_low_club.csv",
    ...
    def _load_hand_descriptions(self) -> dict[int, str]:
        ...
        if self.eval_type in [
            EvaluationType.GAME_49,
            EvaluationType.GAME_58,
            EvaluationType.GAME_6,
            EvaluationType.GAME_ZERO,
            EvaluationType.GAME_ZERO_6,
            EvaluationType.LOW_PIP_6,
            EvaluationType.FOOTBALL,
            EvaluationType.SIX_CARD_FOOTBALL,
            EvaluationType.SEVEN_CARD_FOOTBALL,
        ]:
    ...
    def _describe_hand(self, cards: list[Card], detailed: bool) -> str:
        ...
        # Handle NE_SEVEN_CARD_HIGH (7-card hands)
            ...
            if hand_result.rank == 1:  # Grand Straight Flush
                ...
                return self._describe_straight_flush(
                    cards_used, prefix="Long", min_length=6
                )  # Treat as a straight flush
    ...
    def _describe_straight_flush(self, cards: list[Card], prefix: str | None = None, min_length: int = 5) -> str:
        """
    ...
    def _describe_flush(self, cards: list[Card], prefix: str | None = None, min_length: int = 5) -> str:
        """
    ...
    def _describe_straight(self, cards: list[Card], prefix: str | None = None, min_length: int = 5) -> str:
        """
