...
from ..models.chat import ChatFilter
...
def get_chat_history(table_id: str):
    ...
    try:
        ...
        chat_history = chat_service.get_chat_history(table_id, limit, include_system)

        return jsonify({"table_id": table_id, "messages": chat_history})
...
def get_moderation_history(table_id: str):
    ...
    try:
        ...
        return jsonify({"table_id": table_id, "actions": moderation_history})
...
def get_chat_filters():
    ...
    try:
        ...
        filters = db.session.query(ChatFilter).filter(ChatFilter.is_active == True).all()
...
def add_chat_filter():
    ...
    try:
        ...
        return jsonify({"success": True, "filter": chat_filter.to_dict()})
...
def get_user_chat_status(table_id: str, user_id: str):
    ...
    try:
        ...
        return jsonify({"user_id": user_id, "table_id": table_id, "is_muted": is_muted, "is_banned": is_banned})
