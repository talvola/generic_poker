...
def get_table_participants(table_id: str):
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'error': 'Failed to get table participants'
        }), 500
...
def get_disconnect_stats():
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'error': 'Failed to get disconnect stats'
        }), 500
...
def get_user_disconnect_info(user_id: str):
    ...
    try:
        ...
        if disconnect_info:
            ...
            return jsonify({
                'success': False,
                'error': 'User is not disconnected'
            }), 404
        ...
        return jsonify({
            'success': False,
            'error': 'Failed to get disconnect info'
        }), 500
...
def get_table_disconnects(table_id: str):
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'error': 'Failed to get table disconnects'
        }), 500
...
def cleanup_expired_disconnects():
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'error': 'Failed to cleanup expired disconnects'
        }), 500