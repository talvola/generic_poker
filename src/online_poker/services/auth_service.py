...
class SessionManager:
    ...
    @staticmethod
    def require_authentication() -> dict[str, Any] | None:
        ...
        if not SessionManager.is_user_authenticated():
            return {"success": False, "error": "authentication_required", "message": "Authentication required"}
        return None
    ...
    def _is_session_valid() -> bool:
        ...
        try:
            ...
            return not (not user or not user.is_active)
