...
class PlayerSessionManager:
    ...
    @staticmethod
    def join_table_and_game(user_id: str, table_id: str, buy_in_amount: int,
                           invite_code: Optional[str] = None, password: Optional[str] = None,
                           as_spectator: bool = False) -> Tuple[bool, str, Optional[Dict[str, Any]]]:
        ...
        try:
            ...
            if as_spectator:
                ...
                success, message = session.add_player(
                    user_id, user.username, access_record.current_stack
                )
    ...
    @staticmethod
    def leave_table_and_game(user_id: str, table_id: str, reason: str = "Player left") -> Tuple[bool, str, Optional[Dict[str, Any]]]:
    ...
    @staticmethod
    def handle_player_reconnect(user_id: str, table_id: str) -> Tuple[bool, str, Optional[Dict[str, Any]]]:
    ...
    @staticmethod
    def get_player_info(user_id: str, table_id: str) -> Optional[Dict[str, Any]]:
    ...
    @staticmethod
    def get_table_session_info(table_id: str) -> Optional[Dict[str, Any]]:
    ...
    def cleanup_inactive_sessions(timeout_minutes: int = 30) -> int:
        ...
        try:
            ...
            if total_cleaned > 0:
                logger.info(f"Cleaned up {total_cleaned} inactive sessions ({access_cleaned} access, {session_cleaned} game)")
