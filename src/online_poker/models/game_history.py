...
class GameHistory(db.Model):
    ...
    def __init__(self, table_id: str, hand_number: int, players: List[Dict[str, Any]], 
                 actions: List[Dict[str, Any]], results: Dict[str, Any], 
                 variant: str, betting_structure: str, stakes: Dict[str, int]):
