...
class Transaction(db.Model):
    ...
    table_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("poker_tables.id"))
    ...
    def __init__(self, user_id: str, amount: int, transaction_type: str, description: str, table_id: str | None = None):
    ...
    def create_winnings_transaction(
        cls, user_id: str, amount: int, table_id: str, table_name: str, hand_number: int
    ) -> "Transaction":
