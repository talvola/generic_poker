...
class TableAccess(db.Model):
    ...
    invite_code_used: Mapped[str | None] = mapped_column(String(20))
    ...
    seat_number: Mapped[int | None] = mapped_column()  # None for spectators
    buy_in_amount: Mapped[int | None] = mapped_column()  # Chips bought in with
    current_stack: Mapped[int | None] = mapped_column()  # Current chip count
